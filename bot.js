...
setInterval(() => {
  http.get(`http://illustrious-southern-orbit.glitch.me/`);
}, 280000);
...
const prefix = 'dimo' //البريفكس أو امر التشغيل
...
.setColor("GREEN")
.setDescription(`**~~=~~ 🎮 ProGames 🎮 ~~=~~
---------------------------------
> ╸ 🎮 ┞ ● - ${prefix}fkk --> العب تفكيك الكلمه
> ╸ 🎮 ┞ ● - ${prefix}rkb -->  العب تركيب الكلمه 
> ╸ 🎮 ┞ ● - ${prefix}fast --> العب الكلمه بسرعة
> ╸ 🎮 ┞ ● - ${prefix}math --> العب حل المسئله 
> ╸ 🎮 ┞ ● - ${prefix}puzzle --> العب مقص ورق صخرة 
> ╸ 🎮 ┞ ● - ${prefix}xo --> العب انت وصديقك اكس و اوي 
> ╸ 🎮 ┞●  - ${prefix}rps --> العب حل اللغز
---------------------------------**
** > ╸ 🙏 ┞●  - Server link : https://discord.gg/EUbWKvm 
 > ╸ 🤖 ┞●  - link BoT : https://bit.ly/3kIQ3Wv**
`)
.setFooter('🎮 ProGamesBoT : 2020')
luxy.channel.send({embed:embed});
}
});

client.login("NzM3NzQyMzcwNjU2ODc4Njc1.XyByHw.3UbI4k9hcqkp8JogzGK2693_htE");
